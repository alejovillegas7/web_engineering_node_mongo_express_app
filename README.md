...
* cambiar el String que se esta recibiendo como argumento en los nuevos "res.send" por el dato retornado de la consulta a la DB(segundo argumento de la consulta, despues del argumento de "err")
